...
def  admin_index(request):
    ...
    admin1 = Admin_user(id="1",contact="123",name="zch",college="123")
    admin1.save()
    ...
    #teacher1 = Faculty_user(id="1",contact="123456",name="CaiDeng",college="123",major="jisuanji",degree="doctor",title="professor")
    #teacher1.save()
    #teacher2 = Faculty_user(id="2",contact="123456",name="ChenYue",college="123",major="jisuanji",degree="doctor",title="professor")
    #teacher2.save()
